...
class WinApp(QWidget):
    ...
    def initUI(self):
        # 이미지 추가
        pixmap = QPixmap('./images/kitty.jpg').scaledToWidth(800)  # scaledToWidth() 큰 해상도를 넓이 800으로 고정
        ...
        lblSize.setStyleSheet('Color: pink') #  #ffffff  두칸씩 RGB   ex) 'color: #ff99cc
        ...
        vbox.addLayout(vbox) # Form에 VL 추가와 동일

        self.setWindowIcon(QIcon('./images/iot.png')) # 상단 이미지 변경
    ...
    def setCenter(self): # 원앱을 화면 정중앙에 위치
        gm = self.frameGeometry() # 원앱 자신 위치값
